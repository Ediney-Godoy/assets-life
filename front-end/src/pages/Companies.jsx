...
import { Pencil, Plus, Save, FileDown, FileText, Printer, Trash2 } from 'lucide-react';
    ...
    <section>
      <div className="flex items-center justify-between mb-4">
        ...
        <ActionToolbar
          onNew={onNew}
          onSave={onSave}
          onEdit={() => editingId && onEdit(companies.find((x) => x.id === editingId))}
          onDelete={() => editingId && onDelete(editingId)}
          onPrint={() => window.print()}
          onExportPdf={() => toast(t('export_pdf'))}
          onExportExcel={() => toast(t('export_excel'))}
