...
export function SkeletonCard({ className }) {
  return (
    <div className={clsx('p-5 rounded-xl border border-slate-200 dark:border-slate-800', className)}>
...
export function SkeletonTable({ rows = 5, cols = 4, className }) {
  return (
    <div className={clsx('rounded-lg border border-slate-200 dark:border-slate-800 overflow-hidden', className)}>
      {/* Header */}
